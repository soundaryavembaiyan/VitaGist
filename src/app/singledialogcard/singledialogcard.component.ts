...
@Injectable()
@Component({
  selector: 'app-singledialogcard',
  templateUrl: './singledialogcard.component.html',
  styleUrls: ['./singledialogcard.component.css']
})
export class SingledialogcardComponent implements OnInit {
  ...
  dialogAdd() {
    ...
    const dialogRef = this.dialog.open(DeviceAddedComponent, {
      width: '380px',
      //height:'400px',
...
@Component({
  ...
  templateUrl: './device-added.html',
  styleUrls: ['./singledialogcard.component.css'],
  providers: [DatePipe]
})
export class DeviceAddedComponent implements OnInit {
  reg_device: any;
  device: any;
  device_names: any;
  addedDevices: any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DeviceAddedComponent>,
    private userData: UsersDataService,
    private router: Router,
