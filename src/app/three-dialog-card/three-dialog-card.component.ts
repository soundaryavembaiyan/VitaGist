...
@Injectable()
@Component({
  selector: 'app-three-dialog-card',
  templateUrl: './three-dialog-card.component.html',
  styleUrls: ['./three-dialog-card.component.css']
})
export class ThreeDialogCardComponent implements OnInit {
  ...
  dialogAdd() {
    ...
    const dialogRef = this.dialog.open(DeviceAdded2Component, {
      width: '400px',
      height:'400px',
...
@Component({
  ...
  templateUrl: './device-added2.html',
  styleUrls: ['./three-dialog-card.component.css'],
  providers: [DatePipe]
})
export class DeviceAdded2Component implements OnInit {
  reg_device: any;
  device: any;
  device_names: any;
  addedDevices:any;
  ...
  constructor( 
    ...
    public dialogRef: MatDialogRef<DeviceAdded2Component>,
    private userData: UsersDataService,
    private router: Router,
